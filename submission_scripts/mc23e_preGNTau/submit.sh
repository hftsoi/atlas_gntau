...
--nCore 2 --noEmail --nFilesPerJob 1 --inOutDsJson jobs_datasets_mc23e.json --nFiles 8 --dumpJson jobs_submit_mc23e.json --extOutFile='expert-monitoring.root' \
--inTarBall tarball.tgz --extFile GNTau_config GNTau_config/*.onnx GNTau_config/*.root
